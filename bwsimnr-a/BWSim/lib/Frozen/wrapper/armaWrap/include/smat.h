...
// ---------------------------------------------------------------------
 ...
 sparse_imat operator+(const sparse_imat &, const sparse_imat &);
 sparse_mat operator+(const sparse_mat &, const sparse_mat &);
 sparse_cmat operator+(const sparse_cmat &, const sparse_cmat &);

 sparse_imat operator*(const sparse_imat &, const sparse_imat &);
 sparse_mat operator*(const sparse_mat &, const sparse_mat &);
 sparse_cmat operator*(const sparse_cmat &, const sparse_cmat &);

 ivec operator*(const ivec &, const sparse_imat &);
 vec operator*(const vec &, const sparse_mat &);
 cvec operator*(const cvec &, const sparse_cmat &);

 ivec operator*(const sparse_imat &, const ivec &);
 vec operator*(const sparse_mat &, const vec &);
 cvec operator*(const sparse_cmat &, const cvec &);

 imat trans_mult(const sparse_imat &);
 mat trans_mult(const sparse_mat &);
 cmat trans_mult(const sparse_cmat &);

 sparse_imat trans_mult_s(const sparse_imat &);
 sparse_mat trans_mult_s(const sparse_mat &);
 sparse_cmat trans_mult_s(const sparse_cmat &);

 sparse_imat trans_mult(const sparse_imat &, const sparse_imat &);
 sparse_mat trans_mult(const sparse_mat &, const sparse_mat &);
 sparse_cmat trans_mult(const sparse_cmat &, const sparse_cmat &);

 ivec trans_mult(const sparse_imat &, const ivec &);
 vec trans_mult(const sparse_mat &, const vec &);
 cvec trans_mult(const sparse_cmat &, const cvec &);

 sparse_imat mult_trans(const sparse_imat &, const sparse_imat &);
 sparse_mat mult_trans(const sparse_mat &, const sparse_mat &);
 sparse_cmat mult_trans(const sparse_cmat &, const sparse_cmat &);
