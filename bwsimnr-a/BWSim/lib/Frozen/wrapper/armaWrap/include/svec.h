...
namespace details
{
	...
	template <> struct Sparse_Eps_Type_Selector<bool> {typedef int eps_type;};
}
...
void Sparse_Vec<T>::operator+=(const Vec<T> &v)
{
  ...
  //(v_size == v.size(), "Attempted addition of unequal sized sparse vectors");
...
sparse_ivec operator+(const sparse_ivec &,
                                        const sparse_ivec &);
sparse_vec operator+(const sparse_vec &,
                                       const sparse_vec &);
sparse_cvec operator+(const sparse_cvec &,
                                        const sparse_cvec &);

int operator*(const sparse_ivec &, const sparse_ivec &);
double operator*(const sparse_vec &, const sparse_vec &);
std::complex<double> operator*(const sparse_cvec &,
    const sparse_cvec &);

int operator*(const sparse_ivec &, const ivec &);
double operator*(const sparse_vec &, const vec &);
std::complex<double> operator*(const sparse_cvec &,
    const cvec &);

int operator*(const ivec &, const sparse_ivec &);
double operator*(const vec &, const sparse_vec &);
std::complex<double> operator*(const cvec &,
    const sparse_cvec &);

sparse_ivec elem_mult(const sparse_ivec &,
                                        const sparse_ivec &);
sparse_vec elem_mult(const sparse_vec &, const sparse_vec &);
sparse_cvec elem_mult(const sparse_cvec &,
                                        const sparse_cvec &);

ivec elem_mult(const sparse_ivec &, const ivec &);
vec elem_mult(const sparse_vec &, const vec &);
cvec elem_mult(const sparse_cvec &, const cvec &);

sparse_ivec elem_mult_s(const sparse_ivec &, const ivec &);
sparse_vec elem_mult_s(const sparse_vec &, const vec &);
sparse_cvec elem_mult_s(const sparse_cvec &, const cvec &);

ivec elem_mult(const ivec &, const sparse_ivec &);
vec elem_mult(const vec &, const sparse_vec &);
cvec elem_mult(const cvec &, const sparse_cvec &);

sparse_ivec elem_mult_s(const ivec &, const sparse_ivec &);
sparse_vec elem_mult_s(const vec &, const sparse_vec &);
sparse_cvec elem_mult_s(const cvec &, const sparse_cvec &);
